...
function UpdateTutor() {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:8083/tutor/update" + userid).then(resp => {
            ...
            setsubjectSpecialization(resp.data.subjectSpecialization);
    ...
    const updateTutorSubmit = () => {
        ...
        if (noErrors) {
            ...
            axios.post("http://localhost:8083/tutor/update", payload).then(resp => {
                const obj =
                {
                ...
                alert("User Registerd /Saved/Success");
        ...
        axios.put("http://localhost:8083/tutor/update", payload).then(resp => alert("Tutor updated."));
    ...
    return (<div>
        ...
        <div className="container">
            ...
            <div className="form-group">
                ...
                <input type='text' name='username' value={username} placeholder='UserName' className="form-control" id="username" onChange={(event) => setusername(event.target.value)} />
            ...
            <button onClick={updateTutorSubmit} className="btn btn-primary">Update</button>
